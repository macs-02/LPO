...
public class Tokenizer implements TokenizerInterface {
    ...
    private static final Map<String, TokenType> symbols = new TreeMap<>(); // symbols must be ordered lexicographically, to build a correct regular expression
    ...
    static {
        ...
        /*
         * the regular expression for symbols must be in reversed String
         * order because the regular expression operator '|' is left-preferential! for
         * instance '==' must come before '='
         * remark: the keywords in TreeMap maps are lexicographically ordered, 
         * symbolList.addFirst is used to reverse the order 
         *
